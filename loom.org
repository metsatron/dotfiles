...
NAMING_STANDALONE=" app backup browser claude-idle-supervisor claude-idle-supervisor-tests CODE_OF_SOVEREIGNTY codex-idle-supervisor codex-idle-supervisor-tests css defaults dotcortex fonts gitreleases guests helmcortex-shims icons logseq loom lutris menu music mux nfs odin opencode-idle-supervisor opencode-idle-supervisor-tests provision-host-excludes qemu README root shell shortcuts style submodules term win x11 "
