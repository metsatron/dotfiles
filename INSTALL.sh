...
echo ""
echo "Next steps:"
echo "  1. Log out and back in (or: source ~/.zshenv && exec zsh)"
echo "  2. loom                  (verify all loom verbs work)"
echo "  3. loom flatpak:apply    (install Flatpak apps from manifest)"
echo ""
