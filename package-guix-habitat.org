...
#+BEGIN_SRC scheme :tangle all/.config/guix/manifests/sanctuaries/sanctuary-mide.scm :mkdirp yes
...
#+BEGIN_SRC scheme :tangle all/.config/guix/manifests/sanctuaries/sanctuary-nscde.scm :mkdirp yes
...
#+BEGIN_SRC scheme :tangle all/.config/guix/local-packages/local/packages/quasi88-libretro.scm :mkdirp yes
...
#+BEGIN_SRC scheme :tangle all/.config/guix/local-packages/local/packages/fbneo-libretro.scm :mkdirp yes
