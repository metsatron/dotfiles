...
Binary location: `/home/metsatron/.npm-global/bin/codex` (assuming npm global prefix is `~/.npm-global`)
...
codex exec - --full-auto --skip-git-repo-check --json -c model="o3" <<< "Write unit tests"
...
*** Hermes harness — stow-global
#+BEGIN_SRC markdown :tangle hermes/autonomous-ai-agents/codex/SKILL.md
---
name: codex
