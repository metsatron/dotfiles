...
Hermes mirrors the same skill bodies under =~/.hermes/skills/=, so the tangled
tree stays aligned with this source file as the canonical definition.
...
<<skill-prime-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/prime/SKILL.md :comments no
---
name: prime
description: DotCortex Orientation
model: claude-haiku-4-5-20251001
...
<<skill-verify-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/verify/SKILL.md :comments no
---
name: verify
description: Tool Presence And Help
model: claude-haiku-4-5-20251001
...
<<skill-handoff-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/handoff/SKILL.md :comments no
---
name: handoff
description: Session Handoff
model: claude-sonnet-4-6
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/handoff-verify/SKILL.md :comments no
---
name: handoff-verify
description: Fresh-Context Verification
model: claude-haiku-4-5-20251001
...
<<skill-reflect-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/reflect/SKILL.md :comments no
---
name: reflect
description: Session Reflection
model: claude-sonnet-4-6
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/context-hygiene/SKILL.md :comments no
---
name: context-hygiene
description: Keep context lean and delegate heavy exploration.
model: claude-sonnet-4-6
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/dotcortex-loom/SKILL.md :comments no
---
name: dotcortex-loom
description: Operate the DotCortex literate dotfiles system — tangle org files, stow overlays, run loom verbs for package management (pip, npm, guix, flatpak, snap, cargo, appimage, homebrew), and bootstrap fresh machines.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/dotcortex-package-manifests/SKILL.md :comments no
---
name: dotcortex-package-manifests
description: Manage DotCortex package manifests from root Org sources.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/dotcortex-packages/SKILL.md :comments no
---
name: dotcortex-packages
description: Package manager manifests (guix, pip, npm, flatpak, snap, cargo, appimage, homebrew), SSV format, adding new package managers.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/dotcortex-multihost/SKILL.md :comments no
---
name: dotcortex-multihost
description: Multi-machine deployment (X230, T480s), overlay scoping, HelmCortex integration, bootstrap fresh machines.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/dotcortex-gotchas/SKILL.md :comments no
---
name: dotcortex-gotchas
description: Troubleshooting DotCortex issues — stow conflicts, tangle failures, Guix installer problems, /tmp permissions.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/dotcortex-bootstrap/SKILL.md :comments no
---
name: dotcortex-bootstrap
description: Fresh machine and recovery bootstrap skill.
model: claude-sonnet-4-6
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/helmcortex-pvox/SKILL.md :comments no
---
name: helmcortex-pvox
description: Use HelmCortex VoxForge pvox to speak text, stream transcripts, inspect voice mappings, and work against Flatpak-managed Pied models.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/helmcortex-nexus/SKILL.md :comments no
---
name: helmcortex-nexus
description: Inspect and refresh HelmCortex NEXUS/git mirrors.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/antigravity-config/SKILL.md :comments no
---
name: antigravity-config
description: Manage Antigravity from DotCortex source files.
model: claude-sonnet-4-6
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/prompt-golf/SKILL.md :comments no
---
name: prompt-golf
description: PromptGolf session tracking — swings, holes, tee-off, lie classification, scorecard. Load for any PromptGolf task.
model: claude-sonnet-4-6
...
<<skill-commit-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/commit/SKILL.md :comments no
---
name: commit
description: /commit — Structured Git Commit
model: claude-sonnet-4-6
...
<<skill-defuddle-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/defuddle/SKILL.md :comments no
---
name: defuddle
description: Extract clean markdown from web pages using Defuddle CLI, removing clutter, navigation, and ads.
model: claude-haiku-4-5-20251001
...
<<skill-tangle-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/tangle/SKILL.md :comments no
---
name: tangle
description: Tangle Org files (like the current skills.org) into their final destinations (e.g., all/.agents/skills/).
model: claude-haiku-4-5-20251001
...
<<skill-loom-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/loom/SKILL.md :comments no
---
name: loom
description: Operate DotCortex with loom verbs (e.g., pip:apply, npm:sync, guix:apply, or stow verbs) via full explicit paths for Hermes workflow.
model: claude-haiku-4-5-20251001
...
<<skill-gh-body>>
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/gh/SKILL.md :comments no
---
name: gh
description: GitHub CLI for repo operations, PR management, issue tracking, checking NEXUS repos for updates and releases.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/obsidian-cli/SKILL.md :comments no
---
name: obsidian-cli
description: Use the official Obsidian CLI to act on a live vault, including note CRUD, daily notes, search, tasks, properties, sync, Bases, history, and plugin or theme debugging.
model: claude-haiku-4-5-20251001
...
#+END_SRC
#+BEGIN_SRC hermes :tangle ~/DotCortex/all/.hermes/skills/obsidian-markdown/SKILL.md :comments no
---
name: obsidian-markdown
description: Create and edit Obsidian Flavored Markdown with wikilinks, embeds, callouts, properties, comments, tags, math, and other note-specific syntax.
model: claude-sonnet-4-6
...
# Switch to another machine (stops local, starts remote)
...
```
ThinkPad-T480s|opencode|x230
ThinkPad-X230|opencode|x230
```

Format: `hostname|enabled_agents|ssh_alias`

## Switching Machines

```bash
# Switch to X230 (stops T480s agents, starts X230 agents)
...
2. Target machine must have `telegram-agent-host` installed
