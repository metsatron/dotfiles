...
3. Skills that should work everywhere tangle to both =.agents/skills/= (universal) and =.claude/skills/= (Claude Code).
4. Harness-exclusive skills tangle only to their harness directory.
5. When a harness needs extra content beyond the shared body, append it inline in that harness's tangle block after the noweb reference.
...
#+END_SRC
#+BEGIN_SRC markdown :tangle .claude/skills/antigravity-config/SKILL.md :comments no
---
name: antigravity-config
description: Manage Antigravity from DotCortex source files.
---
...
#+END_SRC
#+BEGIN_SRC markdown :tangle .agents/skills/commit/SKILL.md :comments no
---
name: commit
...
<<skill-commit-body>>
#+END_SRC
#+BEGIN_SRC markdown :tangle .claude/skills/commit/SKILL.md :comments no
---
name: commit
description: /commit — Structured Git Commit
---
...
#+END_SRC
#+BEGIN_SRC markdown :tangle .agents/skills/obsidian-cli/SKILL.md :comments no
---
name: obsidian-cli
...
#+END_SRC
#+BEGIN_SRC markdown :tangle .claude/skills/obsidian-cli/SKILL.md :comments no
---
name: obsidian-cli
description: Use the official Obsidian CLI to act on a live vault, including note CRUD, daily notes, search, tasks, properties, sync, Bases, history, and plugin or theme debugging.
---
...
#+END_SRC
#+BEGIN_SRC markdown :tangle .agents/skills/obsidian-markdown/SKILL.md :comments no
---
...
#+END_SRC
#+BEGIN_SRC markdown :tangle .claude/skills/obsidian-markdown/SKILL.md :comments no
---
name: obsidian-markdown
description: Create and edit Obsidian Flavored Markdown with wikilinks, embeds, callouts, properties, comments, tags, math, and other note-specific syntax.
---
