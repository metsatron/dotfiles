...
- **S24** (Samsung Galaxy S24, Android/Termux): SSH alias `s24`, overlays: `all termux s24`, verb: `loom stow:s24`; no Guix, use `STOW_PKGS='all termux s24' make safe-stow` if loom unavailable
