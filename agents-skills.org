...
Use this skill when you need to tangle org files into overlay directories or generate SKILL.md files from agents-skills.org.
...
/home/metsatron/.local/bin/tangle-one agents-skills.org
