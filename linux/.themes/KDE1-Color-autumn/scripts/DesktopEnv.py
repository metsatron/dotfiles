...
class DesktopEnv():
	...
	try:
		...
		if first_run:
		    ...
		    args0 = ["xfconf-query", "-c", "xfce4-desktop", "-p", "/backdrop/screen0/monitorVirtual1/image-path", "-s", file_loc]
		    args1 = ["xfconf-query", "-c", "xfce4-desktop", "-p", "/backdrop/screen0/monitorVirtual1/image-style", "-s", "3"]
		    args2 = ["xfconf-query", "-c", "xfce4-desktop", "-p", "/backdrop/screen0/monitorVirtual1/image-show", "-s", "true"]
		    subprocess.Popen(args0)
		    subprocess.Popen(args1)
		    subprocess.Popen(args2)
