...
complete -c aria2c -s j -l max-concurrent-downloads --description 'Set the maximum number of parallel downloads fo… [See Man Page]'
...
complete -c aria2c -l no-proxy --description 'Specify a comma separated list of host names, d… [See Man Page]'
...
complete -c aria2c -l server-stat-of --description 'Specify the file name to which performance prof… [See Man Page]'
complete -c aria2c -l server-stat-if --description 'Specify the file name to load performance profi… [See Man Page]'
...
complete -c aria2c -l http-proxy --description 'Use a proxy server for HTTP.'
complete -c aria2c -l http-proxy-passwd --description 'Set password for \\%--http-proxy. UNINDENT NDENT 0. 0.'
complete -c aria2c -l http-proxy-user --description 'Set user for \\%--http-proxy. UNINDENT NDENT 0. 0.'
complete -c aria2c -l https-proxy --description 'Use a proxy server for HTTPS.'
complete -c aria2c -l https-proxy-passwd --description 'Set password for \\%--https-proxy. UNINDENT NDENT 0. 0.'
complete -c aria2c -l https-proxy-user --description 'Set user for \\%--https-proxy. UNINDENT NDENT 0. 0.'
complete -c aria2c -l private-key --description 'Use the private key in FILE.'
complete -c aria2c -l referer --description 'Set an http referrer (Referer).'
...
complete -c aria2c -l ftp-proxy --description 'Use a proxy server for FTP.'
...
complete -c aria2c -l 'ftp-reuse-connection[' --description 'Reuse connection in FTP.  Default: true . UNINDENT NDENT 0. 0.'
...
complete -c aria2c -l 'bt-detach-seed-only[' --description 'Exclude seed only downloads when counting concu… [See Man Page]'
...
complete -c aria2c -l 'rpc-save-upload-metadata[' --description 'Save the uploaded torrent or metalink meta data… [See Man Page]'
...
complete -c aria2c -l dscp --description 'Set DSCP value in outgoing IP packets of BitTor… [See Man Page]'
...
complete -c aria2c -l min-tls-version --description 'Specify minimum SSL/TLS version to enable.'
