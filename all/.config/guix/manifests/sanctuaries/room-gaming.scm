...
(define redstone-nextstep-dock
  (load (string-append (dirname (current-filename))
                       "/redstone-nextstep-dock-package.scm")))
...
(packages->manifest
 (cons* pcmanfm-redstone
        ...
        redstone-nextstep-dock ; NeXT logo tile for IceWM's right-edge DockApps panel
   ...
   "font-tex-gyre" ; TeX Gyre Heros — declared NeXTSTEP titlebar/menu face; projected and verified by redstone-9x-fonts-apply
   ...
   "wmclock" "wmcpuload" "wmbattery" "wmnd" "wmamixer" ; NeXTSTEP DockApps tower
