...
;; --- Cargo ---
   ...
   (task 'backup:games
         "Mirror ~/Games to ironwolf02"
         (lambda () (sh "backup-games --auto -y")))

   (task 'backup:retropie
         "Mirror ~/RetroPie to ironwolf02"
