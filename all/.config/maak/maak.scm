...
(define tasks
  (list
   ...
   (task 'stow:t480 "Safe stow T480 Vendefoul Wolf overlays (all linux t480)"
         (lambda () (stow-then-reload-tmux "STOW_PKGS='all linux t480' make safe-stow")))
   ...
   (task 'guix:sanctuary-apply "Build desktop-common + sanctuary + gaming Guix profiles"
         (lambda () (mk-guix "guix-desktop-common guix-sanctuary-qtile guix-sanctuary-gnustep guix-sanctuary-cde guix-room-gaming")))
