...
class ReconcileTests(unittest.TestCase):
    def setUp(self):
        ...
        # Use the interpreter running the suite so direct exec does not depend on
        # Termux translating a conventional /usr/bin/env shebang.
        self.reporter.write_text("#!" + sys.executable + "\n" + '''
