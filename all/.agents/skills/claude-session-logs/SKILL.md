...
6. Search the newest candidates for the user's quoted continuation anchor with `rg -n -F`.
7. If exact matching fails, search distinctive fragments with `rg -n -i -C 8`.
